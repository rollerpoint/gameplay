...
class Wptelegram {
	...
	private function load_dependencies() {
		...
		/**
		 * The class responsible for handling the Telegram API
		 */
		require_once WPTELEGRAM_DIR . '/includes/telegram-api/class-wptelegram-telegram-api.php';

		/**
		 * The Telegram API Client
		 */
		require_once WPTELEGRAM_DIR . '/includes/telegram-api/class-wptelegram-telegram-client.php';

		/**
		 * The class responsible for handling the Telegram API Requests
		 */
		require_once WPTELEGRAM_DIR . '/includes/telegram-api/class-wptelegram-telegram-request.php';

		/**
		 * The class responsible for handling the Telegram API Responses
		 */
		require_once WPTELEGRAM_DIR . '/includes/telegram-api/class-wptelegram-telegram-response.php';
