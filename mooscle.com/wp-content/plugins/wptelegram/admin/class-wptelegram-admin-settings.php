        ...
        $settings_fields = array(
            ...
            'wptelegram_notify' => array(
                ...
                array(
                    ...
                    'desc'     => sprintf( __( 'User can enter the Telegram information on %sprofile%s page', 'wptelegram' ), '<a href="' . esc_url( get_edit_profile_url() . '#telegram-info' ) . '">', '</a>' ),
        ...
        <p><b><?php esc_html_e( 'IMPORTANT! First complete at least first 4 steps in Telegram Settings section, otherwise notifications won\'t be sent', 'wptelegram' );?></b></p>
         <ul style="list-style-type: disc;margin-left: 20px;">
             ...
             <li><?php echo __( 'Follow these steps:', 'wptelegram' );?>
                 <ol style="list-style-type: decimal;">
                    <li><?php echo sprintf( __( 'Send a message to %s', 'wptelegram' ), '<a href="https://t.me/TheChatInfoBot"  target="_blank">@TheChatInfoBot</a>' );?></li>
                    <li><?php esc_html_e( 'It will send you your Telegram chat_id.', 'wptelegram' );?></li>
                    <li><?php echo sprintf( esc_html__( 'If you want to receive notifications into a group, then add %s to the group and it will send you the group ID.', 'wptelegram' ), '@TheChatInfoBot' );?>
                        <ul style="list-style-type: disc;margin-left: 20px;"">
