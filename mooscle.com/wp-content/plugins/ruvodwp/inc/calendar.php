...
function digital_releases_calendar_content( $atts, $content = null){
    ...
    $filters_form_elements = '
        <div class="filter-item">
            ...
            <div><input type="search" name="title" placeholder="'.__('Title',RUVOD_TEXT_DOMAIN).'"></div>
        </div>
        <div class="filter-item">
        ...
        <div class="submit-container">
            <a href="http://ruvod.com/wp-content/uploads/2017/10/RELEASE-PLAN-FOR-RUVOD.xlsx" class="btn btn-primary">
