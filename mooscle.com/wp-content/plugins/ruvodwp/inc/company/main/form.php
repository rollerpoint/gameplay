...
<div class="edit-my-company">
    <h4 class="entry-title">
        <?php _e('Company editing', RUVOD_TEXT_DOMAIN) ?>
    </h4>    
    ...
    <form class="ajax-form company-form company-blog-form" id="company-form" action="/wp-admin/admin-ajax.php" method="post">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="wp-chose-image pull-left" data-size="full">
                ...
                <div class="float-image-sibling">
                    ...
                    <div class="form-group">
                        <label><?php _e('Site', RUVOD_TEXT_DOMAIN) ?></label>
                        <input type="url" class="form-control" value="<?php echo $data['wpcf-site'] ?>" name="wpcf-site">
                    </div>
                    <div class="form-group">
