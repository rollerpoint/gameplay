 ...
 */
add_filter( 'template_include', array( 'Digezine_Wrapping', 'wrap' ), 99 );
add_filter( 'digezine_wrap_base', 'digezine_wrap_base_cpts' );
 ...
 */
function digezine_template_path() {
	return Digezine_Wrapping::$main_template;
}
 ...
 */
function digezine_template_base() {
	return Digezine_Wrapping::$base;
}

if ( ! class_exists( 'Digezine_Wrapping' ) ) {
	...
	class Digezine_Wrapping {
		...
		/**
		 * Initialize new instance of Digezine_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'digezine_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Digezine_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function digezine_wrap_base_cpts( $templates ) {
