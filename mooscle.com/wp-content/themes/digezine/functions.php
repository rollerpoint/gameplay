...
if ( ! class_exists( 'Digezine_Theme_Setup' ) ) {
	...
	class Digezine_Theme_Setup {
		...
		public function register_assets() {
			...
			$styles_widgets_init = dirname(__FILE__) . '/assets/js/custom_widgets_init.js';

			wp_register_script( 'custom-widgets-init', DIGEZINE_THEME_URI . '/assets/js/custom_widgets_init.js', array( 'jquery' ), filemtime( $styles_widgets_init ) );
