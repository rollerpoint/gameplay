...
if ( ! class_exists( 'Cherry_Dynamic_Css' ) ) {
	...
	class Cherry_Dynamic_Css {
		...
		public function init_dynamic_css() {
			...
			add_action( 'wp_enqueue_scripts', array( $this, 'add_inline_css' ), 150 );
		}
		...
		public function add_inline_css() {
			wp_add_inline_style( 'digezine-theme-style', $this->get_inline_css() );
		}
