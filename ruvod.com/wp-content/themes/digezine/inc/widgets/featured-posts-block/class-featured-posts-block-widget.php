...
if ( ! class_exists( 'Digezine_Featured_Posts_Block_Widget' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Digezine_Featured_Posts_Block_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Featured Posts Block', 'digezine' );
			$this->widget_description = esc_html__( 'This widget displays latest posts', 'digezine' );
			$this->widget_id          = 'digezine_widget_featured_posts_block';
			...
			$this->settings = array(
				...
				'layout' => array(
					...
					'label'   => esc_html__( 'Layout', 'digezine' ),
		...
		public function render_layout( $options = array() ) {
			...
			$item_template = locate_template(  apply_filters( 'digezine_featured_posts_block_widget_view_dir', 'inc/widgets/featured-posts-block/views/item.php' ), false, false );
			 ...
			 */
			$query = apply_filters( 'digezine_featured_posts_block_query', $query, $this->instance );
		...
		public function get_layouts() {
			return array(
				...
				'layout-2' => array(
					'name'   => esc_html__( 'Type #2', 'digezine' ),
					'amount' => 5,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-3' => array(
					'name'   => esc_html__( 'Type #3', 'digezine' ),
					'amount' => 4,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-4' => array(
					'name'   => esc_html__( 'Type #4', 'digezine' ),
					'amount' => 4,
					'markup' => array(
						array(
							'type'  => 'item',
				...
				'layout-5' => array(
					'name'   => esc_html__( 'Type #5', 'digezine' ),
					'amount' => 3,
					'markup' => array(
						array(
							'type'  => 'item',
	...
	add_action( 'widgets_init', 'digezine_register_featured_posts_block_widget' );

	if ( false === function_exists( 'digezine_register_featured_posts_block_widget' ) ) {
		/**
		 * Register featured posts block widget.
		 */
		function digezine_register_featured_posts_block_widget() {
			register_widget( 'Digezine_Featured_Posts_Block_Widget' );
		}
	}
}
