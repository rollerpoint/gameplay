...
if ( ! class_exists( 'Digezine_Widget_Area' ) ) {

	/**
	 * Class Digezine_Widget_Area.
	 */
	class Digezine_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'digezine_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'digezine_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'digezine_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function digezine_widget_area() {
		return Digezine_Widget_Area::get_instance();
	}

	digezine_widget_area();
}
