...
Description: Add custom JavaScript to your site from a professional editor in the WordPress admin (Admin Menu &gt; Appearance &gt; <a href="themes.php?page=tc-custom-javascript">Custom JavaScript</a>).
Version: 1.1.1
Author: Tiny Code
